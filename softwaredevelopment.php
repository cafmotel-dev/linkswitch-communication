...
<head>
    ...
    <!-- ======== Page title ============ -->
    <title>Software Development- LinkSwitch</title>
    <!--<< Favcion >>-->
...
<div class="scrolling-banner">
  <div class="scrolling-track">
    <div class="scrolling-content">
      <div class="item"><i class="fa-solid fa-code"></i><span>Custom Software Solutions</span></div>
      <div class="item"><i class="fa-solid fa-mobile-screen-button"></i><span>Mobile App Development</span></div>
      <div class="item"><i class="fa-solid fa-cloud"></i><span>SaaS Platform Development</span></div>
      <div class="item"><i class="fa-solid fa-gears"></i><span>API Integration & Architecture</span></div>
      <div class="item"><i class="fa-solid fa-database"></i><span>ERP & CRM Systems</span></div>
      <div class="item"><i class="fa-solid fa-screwdriver-wrench"></i><span>Legacy Code Modernization</span></div>
      <div class="item"><i class="fa-solid fa-code-branch"></i><span>Version Control & CI/CD</span></div>
                                ...
                                <div class="widget-categories">
                                    <ul>
                                        ...
                                        <li><a href="cloudservices.php">Cloud Services <i
                                                    class="fa-solid fa-arrow-right-long"></i></a></li>
                                        <li class="active"><a href="softwaredevelopment.php">Software Development <i
                                                    class="fa-solid fa-arrow-right-long"></i></a></li>
                    ...
                    <div class="col-12 col-lg-8 order-1 order-md-2">
                        <div class="service-details-items">
                            <div class="details-image">
                                <img src="assets/img/bg/screen.jpg" alt="img">
                            </div>
                            <div class="details-content">
                                  <h4>📱 Custom Software Development Solutions</h4>
    <p class="mt-3">
        We specialize in building tailor-made software—whether it's mobile apps, SaaS platforms, APIs, or robust ERP and CRM systems. Our team crafts solutions that align perfectly with your business goals, ensuring functionality, performance, and scalability.
    </p>
    <p class="mt-3">
        From modernizing outdated legacy systems to engineering future-ready platforms, we deliver secure, user-friendly applications built to grow with your business. Whether you’re launching a startup or optimizing enterprise workflows, we bring your vision to life through powerful code.
    </p>
        ...
        <p>
            Get scalable, future-proof software designed to adapt and evolve with your business.
        </p>
        <ul class="list">
            <li>
                                ...
                                <div class="image-area">
                                    <div class="row g-4">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="thumb">
                                                <img src="assets/img/bg/we.jpg" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="thumb">
                                                <img src="assets/img/bg/sdev.jpg" alt="img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
   ...
   <div class="hilight-text mt-4 mb-4">
    <p>
        Empower your business with cutting-edge software built for performance, security, and scalability. From intuitive mobile apps to complex enterprise systems, we turn your ideas into high-performing digital solutions. Whether you're modernizing legacy platforms or developing from scratch, our expert developers craft reliable, future-ready software tailored to your needs. Partner with us to streamline workflows, enhance user experiences, and stay ahead in the digital game.
    </p>
