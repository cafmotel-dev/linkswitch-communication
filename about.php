...
<body>
 ...
 <?php include 'header.php'; ?>
    ...
    <section class="about-section section-padding fix bg-cover"
        style="background-image: url('assets/img/service/service-bg-2.jpg');">
        <div class="container">
                    ...
                    <div class="col-lg-6">
                        <div class="about-image-items">
                            ...
                            <div class="about-image-1 bg-cover wow fadeInLeft" data-wow-delay=".3s"
                                style="background-image: url('assets/img/about/03.png');">
                        ...
                        <div class="about-content">
                            ...
                            <div class="about-icon-items">
                                <div class="icon-items wow fadeInUp" data-wow-delay=".7s">
                                    ...
                                    <div class="content">
                                        <h4>Smart Innovations</h4>
                                        <p>
                                          Driven by insight, powered by advanced tech.
                                        </p>
                                    </div>
                                </div>
                                <div class="icon-items wow fadeInUp me-5" data-wow-delay=".9s">
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                          Powering businesses with secure, scalable tech.
