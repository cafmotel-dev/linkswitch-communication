    ...
    <!-- <div class="breadcrumb-wrapper bg-cover" style="background-image: url('assets/img/breadcrumb.jpg');">
        ...
        <div class="container">
            <div class="page-heading">
                <h1 class="wow fadeInUp" data-wow-delay=".3s">Lending Origination & Servicing Platform</h1>
                <ul class="breadcrumb-items wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <li>
                       Lending Origination & Servicing Platform
                    </li>
                </ul>
            </div>
        </div>
               ...
               <div class="row">
                  <div class="col-xl-6 order-2 order-xl-1">
                     <div class="hero-content style1">
                        ...
                        <h4 class="text-white">Lending Origination & Servicing Platform</h4>

                        <div class="checklist-wrapper style3">
                           <ul class="checklist style3">
                              <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> Streamlines Entire Loan Lifecycle</li>
                              <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> From Application to Repayment Tracking</li>
                           </ul>
                           <ul class="checklist style3">
                              <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> Built for Speed, Compliance & Scale</li>
                              <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> Intuitive UI & Automated Workflows</li>
                           </ul>
                        </div>
                  ...
                  <div class="col-xl-6 order-1 order-xl-2 justify-content-center">
                     <div class="hero-thumb style1">
                        <div class="main-thumb">
                           <img src="assets/img/bg/lending.jpg" alt="thumb">
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="project-details-items">
                            ...
                            <div class="row g-4 justify-content-between">
                                <div class="col-lg-12">
                                    <div class="details-content pt-0">
                                        <h3>Lending Origination & Servicing Platform</h3>
                                        <p>
                                         Lending Origination & Servicing Platform is a comprehensive solution that streamlines the entire lifecycle of a loan—from application and approval to disbursal and repayment tracking. Built for speed, compliance, and scalability, it supports both lenders and borrowers with intuitive interfaces and automated backend workflows. </p>
                                    </div>
                                </div>
                                <!-- <div class="col-lg-4">
                                    <div class="project-catagory">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                Category:
                                                <span>Lending Origination & Servicing Platform</span>
                                            </li>
                                            <li>
                                                Location:
                                                <span>Landon</span>
                            ...
                            <div class="details-content pt-3">
                                <h3>Our Challenge</h3>
                                <p>
                                The client’s legacy system lacked scalability and automation, resulting in processing delays, compliance risks, and poor borrower experience. </p>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <ul class="list">
                                        <li>
                                         ...
                                         Manual loan approval processes delaying disbursals.
                                        </li>
                                        <li>
                                            <i class="fa-regular fa-circle-check"></i>
                                          Lack of integration with credit bureaus and KYC tools.
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <ul class="list">
                                        <li>
                                            <i class="fa-regular fa-circle-check"></i>
                                        Disconnected servicing modules causing repayment mismatches.
                                        </li>
                                        <li>
                                            <i class="fa-regular fa-circle-check"></i>
                                       Limited borrower communication during the loan cycle.
                                        </li>
                                    </ul>
                                </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
            <div class="service-box-items box-shadow">
                ...
                <div class="content">
                    ...
                    <p>
                        Seamlessly collect, verify, and approve loan applications with automated workflows.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".5s">
            <div class="service-box-items box-shadow active">
                ...
                <div class="content">
                    ...
                    <p>
                        Borrowers can track application status, EMIs, and access support in one place.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
            <div class="service-box-items box-shadow">
                ...
                <div class="content">
                    ...
                    <p>
                        Real-time tracking of repayments, delinquencies, and automated follow-ups.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".9s">
            <div class="service-box-items box-shadow">
                ...
                <div class="content">
                    ...
                    <p>
                        Define custom loan products and ensure regulatory compliance at every stage.
                    </p>
                </div>
            </div>
        </div>
...
<p>
The implementation of the Lending Origination & Servicing Platform significantly enhanced operational efficiency. Manual interventions were minimized through automation, leading to faster loan approvals and improved collection accuracy. Borrowers experienced a smoother journey with self-service access and real-time updates, while the organization benefited from greater scalability, compliance, and data-driven decision-making.
</p>
</div>
                            <div class="row g-4 pt-5">
                                <div class="col-lg-6 col-md-6">
