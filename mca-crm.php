...
<head>
    ...
    <!-- ======== Page title ============ -->
    <title> Merchant Cash Advance CRM-LinkSwitch </title>
    <!--<< Favcion >>-->
               ...
               <div class="row">
                  <div class="col-xl-6 order-2 order-xl-1">
                     <div class="hero-content style1">
                        ...
                        <h4 class="text-white">Streamline Deal Tracking & Agent Performance</h4>

                        <div class="checklist-wrapper style3">
                           <ul class="checklist style3">
                              <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> Built for MCA Providers</li>
                              <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> Deal Tracking & Lead Nurturing</li>
                           </ul>
                           <ul class="checklist style3">
                              <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> Integrated Underwriting Tools</li>
                              <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> Close Deals Faster with Full Visibility</li>
                           </ul>
                        </div>
                  ...
                  <div class="col-xl-6 order-1 order-xl-2 justify-content-center">
                     <div class="hero-thumb style1">
                        <div class="main-thumb">
                           <img src="assets/img/bg/merchant.png" alt="thumb">
                        </div>
                     </div>
                  </div>
               </div>
    ...
    <div class="row">
        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
            <div class="service-box-items box-shadow">
                ...
                <div class="content">
                 <h4><a href="#">Deal Intake & Lead Management</a></h4>
<p>
   Capture and assign merchant leads efficiently with complete pipeline visibility and tracking.
</p>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".5s">
            <div class="service-box-items box-shadow active">
                ...
                <div class="content">
                    <h4><a href="#">Automated Underwriting</a></h4>
                    <p>
                        Simplify credit checks, bank statement parsing, and scoring in one place
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
            <div class="service-box-items box-shadow">
                ...
                <div class="content">
                    <h4><a href="#">Agent Performance Tracking</a></h4>
                    <p>
                        Monitor sales activities, response time, and closure rates by individual agents
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".9s">
            <div class="service-box-items box-shadow">
                ...
                <div class="content">
                    <h4><a href="#">Communication & Follow-ups</a></h4>
                    <p>
                        Built-in email, SMS, and task reminders to boost engagement and close deals faster
                    </p>
                </div>
            </div>
        </div>
...
<p>
   The Merchant Cash Advance CRM streamlined the entire funding workflow by centralizing lead data, automating underwriting steps, and enabling real-time agent tracking. It empowered teams to follow up faster, close deals more efficiently, and make data-driven decisions with complete visibility into the funding pipeline.
                            ...
                            <div class="row g-4 pt-5">
                                <div class="col-lg-6 col-md-6">
                                    <div class="thumb">
                                        <img src="assets/img/bg/mca.jpg" alt="img" style="height: 400px;">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="thumb">
                                        <img src="assets/img/bg/mca1.jpg" alt="img" style="height: 400px;">
                                    </div>
                                </div>
                            </div>
                        </div>
