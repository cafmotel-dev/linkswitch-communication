...
<head>
    ...
    <!-- ======== Page title ============ -->
    <title>Call Center Dialer- LinkSwitch</title>
    <!--<< Favcion >>-->
...
<body>
  ...
  <div class="preloader" id="preloader">
   ...
   <?php include 'header.php'; ?>
    ...
    <!-- <div class="breadcrumb-wrapper" style="background-image: url('assets/img/bg/caller.jpg');">
   ...
   <section class="hero-section fix">
      <div class="hero-wrapper style1">
         ...
         <!-- <div class="shape1_3">
            <a href="contact.php"> <img class="rotate360" src="assets/img/shape/heroShape1_3.png" alt="shape"> </a>
         </div> -->
         <!-- <div class="shape1_4 movingX d-none d-xxl-block"><img src="assets/img/shape/heroShape1_4.png" alt="shape">
         </div> -->
         <div class="shape1_5  float-bob-y d-none d-xxl-block mt-40"><img src="assets/img/shape/heroShape1_5.png" alt="shape">
         </div>
         <div class="container">
   ...
   <h6 class="subtitle">
      ...
      Transform Your Call Center with VoIP Technology
   </h6>

  <h4 class="text-white">Enhance Performance with Intelligent Call Center Dialer</h4>


   <div class="checklist-wrapper style3">
      <ul class="checklist style3">
         <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> Predictive & Automated Dialing</li>
         <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> Real-Time Call Analytics</li>
      </ul>
      <ul class="checklist style3">
         <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> CRM Integration & Dashboard</li>
         <li><img src="assets/img/icon/checkmarkIcon2.svg" alt="icon"> Higher Lead Conversion Rates</li>
      </ul>
   </div>
                    ...
                    <div class="col-lg-12">
                        <div class="project-details-items">
                            <!-- <div class="details-image">
                                <img src="assets/img/bg/banner1.png" alt="img" style= "width: 200%; height: 700px !important">
                            </div> -->
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="details-content pt-5">
                                        <h3>Call Center Dialer</h3>
                                        <p>
  ...
  .team-wrapper .thumb img {
    ...
    <div class="team-wrapper space style1" data-bg-src="assets/img/bg/teamBg1_1.png">
                            ...
                            <div class="row g-4 pt-5">
                                <div class="col-lg-6 col-md-6">
                                    <div class="thumb">
                                        <img src="assets/img/project/details-2.jpg" alt="img" class="img-fluid w-100">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="thumb">
                                        <img src="assets/img/project/details-3.jpg" alt="img" class="img-fluid w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="preview-area">
                            <div class="preview-item">
                                ...
                                <div class="content">
                                    <h3><a href="index.php">Preview</a></h3>
                                    <p>Home</p>
                                </div>
                            </div>
                            <div class="preview-item">
                                <div class="content text-right">
                                    <h3><a href="callchex-qa.php">Next</a></h3>
